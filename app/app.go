...
import (
	...
	"github/chancebet/blockchain/docs"
)
...
func New(
	...
	*/
	...
	app.BlockchainKeeper = *blockchainmodulekeeper.NewKeeper(
		appCodec,
		keys[blockchainmoduletypes.StoreKey],
		keys[blockchainmoduletypes.MemStoreKey],
		app.GetSubspace(blockchainmoduletypes.ModuleName),
	)
	blockchainModule := blockchainmodule.NewAppModule(appCodec, app.BlockchainKeeper, app.AccountKeeper, app.BankKeeper)
